...
Per Importare il DB andare sulla workbench di MySQL, sulla barra degi strumenti cliccare
 Server-> Data Import.

Spuntare il casella "Import from Self-Contained file" e specificare il percorso di 
sample db (...../SAMPLEJava/db/sampledb.sql).
